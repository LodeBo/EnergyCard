...
(() => {
      ...
      const style = `
        <style>
          ...
          .wrap {
            ...
            align-items: center;
            justify-content: center; /* Houdt donut en legenda centraal als een compact blok */
            position: relative;
            box-sizing: border-box;
            padding: 16px 24px;
            gap: ${isRight ? '32px' : '8px'}; /* De ruimte TUSSEN de ring en de legenda */
          }
          .chart-container {
            flex: 0 0 auto;
            width: 200px; /* Vaste breedte voor de donut zodat hij niet vervormt */
            display: flex;
            align-items: center;
          ...
          .legend {
            ...
            flex: 0 1 auto; /* Zorgt dat de legenda stopt met groeien naar de rechter rand */
            min-width: 160px; /* Zorgt dat de cijfers mooi op 1 lijn staan */
          }
          .legend-item {
            display: flex;
            align-items: center;
            justify-content: space-between;
            gap: 24px; /* De minimale ruimte tussen de tekst en de cijfers */
            width: 100%;
          }
          .legend-left {
            display: flex;
  ...
  try {
    ...
    window.customCards.push({
      type: "energy-card",
      name: "EnergyCard",
      description: "Custom Energy Card v1.1.0",
      preview: true,
    });
